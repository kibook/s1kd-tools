...
struct metadata metadata[] = {
	...
	{"responsiblePartnerCompany",
		"//dmStatus/responsiblePartnerCompany/enterpriseName",
		show_simple_node,
		edit_simple_node,
		NULL},
	{"originator",
		"//dmStatus/originator/enterpriseName",
		show_simple_node,
		edit_simple_node,
		NULL},
	{"responsiblePartnerCompanyCode",
		"//dmStatus/responsiblePartnerCompany/@enterpriseCode",
		show_ent_code,
		edit_ent_code,
		create_rpc_ent_code},
	{"originatorCode",
		"//dmStatus/originator/@enterpriseCode",
		show_ent_code,
		edit_ent_code,
	...
	{"applic",
		...
		NULL},
	{"brex",
		"//dmStatus/brexDmRef/dmRef/dmRefIdent/dmCode",
		show_dmcode,
		edit_dmcode,
		NULL},
	{"act",
		"//dmStatus/applicCrossRefTableRef/dmRef/dmRefIdent/dmCode",
		show_dmcode,
		edit_dmcode,
		create_act_ref},
	{"issueType",
